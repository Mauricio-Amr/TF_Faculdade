''' -----------------------------------------------------------------
    ...
    Data: 10/10/2021
    Lista: 04 - 14
    Enunciado:14 – Escreva um programa que leia números inteiros
    do teclado. O programa deve ler os números até que o usuário
    digite 0 (zero). No final da execução, exiba a quantidade de
